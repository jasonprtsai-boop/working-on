...
export const UIRegistry = {
    ...
    init() {
        this.refs = {
            ...
            consoleRobotReadinessAlert: document.getElementById('console-robot-readiness-alert'),
            consoleRobotReadinessTitle: document.getElementById('console-robot-readiness-title'),
            consoleRobotReadinessDetail: document.getElementById('console-robot-readiness-detail'),
